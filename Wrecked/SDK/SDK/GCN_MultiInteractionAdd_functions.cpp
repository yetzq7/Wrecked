...
#include "GCN_MultiInteractionAdd_classes.hpp"
#include "GCN_MultiInteractionAdd_parameters.hpp"
...
void UGCN_MultiInteractionAdd_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCN_MultiInteractionAdd_C", "OnBurst");

	Params::GCN_MultiInteractionAdd_C_OnBurst Parms{};
...
void UGCN_MultiInteractionAdd_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCN_MultiInteractionAdd_C", "OnBurstGeneric");

	Params::GCN_MultiInteractionAdd_C_OnBurstGeneric Parms{};
