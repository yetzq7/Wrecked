...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Athena_Flopper_C;                // 0x0DA8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GA_Athena_Flopper_C">();
	}
	static class UGA_Athena_Flopper_C* GetDefaultObj()
	{
