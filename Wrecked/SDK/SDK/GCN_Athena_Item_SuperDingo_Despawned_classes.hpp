...
class UGCN_Athena_Item_SuperDingo_Despawned_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Athena_Item_SuperDingo_Despawned_C">();
	}
	static class UGCN_Athena_Item_SuperDingo_Despawned_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Athena_Item_SuperDingo_Despawned_C>();
	}
};
