...
{
public:
	uint8                                         Pad_18[0x10];                                      // 0x0018(0x0010)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_151[0x37];                                     // 0x0151(0x0037)(Fixing Size After Last Property [ Dumper-8 ])
	class FString                                 JoinMethod;                                        // 0x0188(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_198[0x30];                                     // 0x0198(0x0030)(Fixing Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_18[0x9];                                       // 0x0018(0x0009)(Fixing Size After Last Property [ Dumper-8 ])
	struct FPartyPrivacySettings                  PrivacySettings;                                   // 0x0021(0x0003)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_24[0x34];                                      // 0x0024(0x0034)(Fixing Size After Last Property [ Dumper-8 ])
