...
#include "GCN_Physics_Tree_Destruction_Burst_classes.hpp"
#include "GCN_Physics_Tree_Destruction_Burst_parameters.hpp"
...
void UGCN_Physics_Tree_Destruction_Burst_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Physics_Tree_Destruction_Burst_C", "OnBurstGeneric");

	Params::GCN_Physics_Tree_Destruction_Burst_C_OnBurstGeneric Parms{};
