...
class UGCN_Athena_SwimSprintBoost_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Athena_SwimSprintBoost_C">();
	}
	static class UGCN_Athena_SwimSprintBoost_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Athena_SwimSprintBoost_C>();
	}
};
