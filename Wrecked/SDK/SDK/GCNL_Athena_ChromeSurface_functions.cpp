...
void AGCNL_Athena_ChromeSurface_C::ExecuteUbergraph_GCNL_Athena_ChromeSurface(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_ChromeSurface_C", "ExecuteUbergraph_GCNL_Athena_ChromeSurface");
...
void AGCNL_Athena_ChromeSurface_C::OnApplicationGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_ChromeSurface_C", "OnApplicationGeneric");
...
void AGCNL_Athena_ChromeSurface_C::OnRemovalGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_ChromeSurface_C", "OnRemovalGeneric");
