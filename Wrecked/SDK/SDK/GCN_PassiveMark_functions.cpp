...
#include "GCN_PassiveMark_classes.hpp"
#include "GCN_PassiveMark_parameters.hpp"
...
void UGCN_PassiveMark_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_PassiveMark_C", "OnBurstGeneric");

	Params::GCN_PassiveMark_C_OnBurstGeneric Parms{};
