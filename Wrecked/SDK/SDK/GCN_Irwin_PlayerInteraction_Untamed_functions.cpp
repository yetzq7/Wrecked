...
#include "GCN_Irwin_PlayerInteraction_Untamed_classes.hpp"
#include "GCN_Irwin_PlayerInteraction_Untamed_parameters.hpp"
...
void UGCN_Irwin_PlayerInteraction_Untamed_C::OnBurstNiagara(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UNiagaraComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Irwin_PlayerInteraction_Untamed_C", "OnBurstNiagara");

	Params::GCN_Irwin_PlayerInteraction_Untamed_C_OnBurstNiagara Parms{};
