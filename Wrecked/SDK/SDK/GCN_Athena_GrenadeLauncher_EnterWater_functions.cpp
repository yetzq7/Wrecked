...
#include "GCN_Athena_GrenadeLauncher_EnterWater_classes.hpp"
#include "GCN_Athena_GrenadeLauncher_EnterWater_parameters.hpp"
...
void UGCN_Athena_GrenadeLauncher_EnterWater_C::OnBurstNiagara(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UNiagaraComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_GrenadeLauncher_EnterWater_C", "OnBurstNiagara");

	Params::GCN_Athena_GrenadeLauncher_EnterWater_C_OnBurstNiagara Parms{};
