...
class UGCN_Athena_Tether_FallLanding_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Athena_Tether_FallLanding_C">();
	}
	static class UGCN_Athena_Tether_FallLanding_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Athena_Tether_FallLanding_C>();
	}
};
