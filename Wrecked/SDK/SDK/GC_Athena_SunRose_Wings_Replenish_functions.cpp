...
#include "GC_Athena_SunRose_Wings_Replenish_classes.hpp"
#include "GC_Athena_SunRose_Wings_Replenish_parameters.hpp"
...
void UGC_Athena_SunRose_Wings_Replenish_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Athena_SunRose_Wings_Replenish_C", "OnBurstGeneric");

	Params::GC_Athena_SunRose_Wings_Replenish_C_OnBurstGeneric Parms{};
