...
struct GCN_Athena_FringePlank_Reveal_C_ExecuteUbergraph_GCN_Athena_FringePlank_Reveal final
{
public:
	...
	float                                         CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_1;  // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function GCN_Athena_FringePlank_Reveal.GCN_Athena_FringePlank_Reveal_C.OnExecute
// 0x01C8 (0x01C8 - 0x0000)
struct GCN_Athena_FringePlank_Reveal_C_OnExecute final
{
public:
	...
	bool                                          CallFunc_IsLocallyControlled_ReturnValue;          // 0x01BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_OnExecute_ReturnValue;                    // 0x01BB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	double                                        K2Node_VariableSet_SweepRadius_ImplicitCast;       // 0x01C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function GCN_Athena_FringePlank_Reveal.GCN_Athena_FringePlank_Reveal_C.ReceiveEndPlay
// 0x0001 (0x0001 - 0x0000)
struct GCN_Athena_FringePlank_Reveal_C_ReceiveEndPlay final
{
public:
