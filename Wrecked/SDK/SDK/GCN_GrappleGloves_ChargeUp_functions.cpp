...
#include "GCN_GrappleGloves_ChargeUp_classes.hpp"
#include "GCN_GrappleGloves_ChargeUp_parameters.hpp"
...
void AGCN_GrappleGloves_ChargeUp_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_GrappleGloves_ChargeUp_C", "OnBurstGeneric");

	Params::GCN_GrappleGloves_ChargeUp_C_OnBurstGeneric Parms{};
