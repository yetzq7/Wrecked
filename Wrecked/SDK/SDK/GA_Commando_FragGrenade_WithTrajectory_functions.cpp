...
void UGA_Commando_FragGrenade_WithTrajectory_C::SetupGrenade(double AimPitch, class UClass** Base_Grenade, double* Projectile_Speed, struct FFortGameplayEffectContainerSpec* Explosion_Gameplay_Spec, double* Projectile_Gravity_Scale)
{
	static class UFunction* Func = nullptr;
...
void UGA_Commando_FragGrenade_WithTrajectory_C::SpawnFragGrenade(class UClass* ProjectileClass_0, struct FVector& SpawnLocation, const struct FRotator& InputPin, const struct FFortGameplayEffectContainerSpec& EffectContainerSpecToApplyOnExplode, double InitialSpeed, double GravityScale_0)
{
	static class UFunction* Func = nullptr;
...
void UGA_Commando_FragGrenade_WithTrajectory_C::CalcGrenadeSpeedFromPitch(double AimPitch, double* GrenadeSpeed) const
{
	static class UFunction* Func = nullptr;
