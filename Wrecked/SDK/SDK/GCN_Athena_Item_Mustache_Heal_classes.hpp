...
class UGCN_Athena_Item_Mustache_Heal_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Athena_Item_Mustache_Heal_C">();
	}
	static class UGCN_Athena_Item_Mustache_Heal_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Athena_Item_Mustache_Heal_C>();
	}
};
