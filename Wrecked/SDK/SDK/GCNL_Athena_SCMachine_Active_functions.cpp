...
void AGCNL_Athena_SCMachine_Active_C::ExecuteUbergraph_GCNL_Athena_SCMachine_Active(int32 EntryPoint)
{
...
void AGCNL_Athena_SCMachine_Active_C::OnLoopingStart(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents)
{
	static class UFunction* Func = nullptr;
