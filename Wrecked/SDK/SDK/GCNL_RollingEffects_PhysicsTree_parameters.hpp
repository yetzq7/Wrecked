...
struct GCNL_RollingEffects_PhysicsTree_C_ExecuteUbergraph_GCNL_RollingEffects_PhysicsTree final
{
public:
	...
	class ABGA_PhysicsTreeLog_C*                  K2Node_DynamicCast_AsBGA_Physics_Tree_Log;         // 0x0208(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ABGA_PhysicsTreeLog_C*                  K2Node_DynamicCast_AsBGA_Physics_Tree_Log_1;       // 0x0218(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct GCNL_RollingEffects_PhysicsTree_C_OnLoopingStartGeneric final
{
public:
...
struct GCNL_RollingEffects_PhysicsTree_C_OnRemovalGeneric final
{
public:
	class AActor*                                 MyTarget;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                 Parameters;                                        // 0x0008(0x00D0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
