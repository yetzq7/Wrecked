...
namespace Offsets
{
	constexpr int32 GObjects          = 0x12B99C10;
	constexpr int32 AppendString      = 0x0140C6FC;
	constexpr int32 GNames            = 0x12D85B40;
	constexpr int32 GWorld            = 0x12BC1FD0;
	constexpr int32 ProcessEvent      = 0x014C329C;
	constexpr int32 ProcessEventIdx   = 0x0000004D;
    constexpr int32 Free              = 0x00000000;
    constexpr int32 Realloc           = 0x04A99A2C;
}
