...
{
public:
	class FName                                   PinLabel;                                          // 0x0000(0x0004)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_369[0x7];                                      // 0x0369(0x0007)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
{
public:
	struct FPCGMeshInstanceList                   InstanceList;                                      // 0x0000(0x0270)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	const class UPCGMetadata*                     MetaData;                                          // 0x0270(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           AttributeNames;                                    // 0x0278(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPCGPackedCustomData                   OutPackedCustomData;                               // 0x0288(0x0018)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPCGMeshInstanceList                   InstanceList;                                      // 0x00D8(0x0270)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPCGPackedCustomData                   OutPackedCustomData;                               // 0x0348(0x0018)(Parm, OutParm, NativeAccessSpecifierPublic)
};
