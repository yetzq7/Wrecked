...
{
public:
	struct FFortToastDisplayInfo                  DisplayInfo;                                       // 0x0000(0x0048)(BlueprintVisible, BlueprintReadOnly, Parm)
...
public:
	...
	class UCommonTextBlock*                       TextBlock;                                         // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UCommonTextBlock*                       LocalTextBlock;                                    // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
{
public:
	struct FFortToastDisplayInfo                  DispalyInfo;                                       // 0x0000(0x0048)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
public:
	...
	struct FFortToastDisplayInfo                  K2Node_CustomEvent_DispalyInfo;                    // 0x0028(0x0048)()
	...
	bool                                          CallFunc_IsAssetNull_ReturnValue;                  // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFortToastDisplayInfo                  K2Node_MakeStruct_FortToastDisplayInfo;            // 0x00A8(0x0048)()
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate_1;            // 0x00F0(0x000C)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
