...
#include "GCN_EnvCampFire_StokeBurst_classes.hpp"
#include "GCN_EnvCampFire_StokeBurst_parameters.hpp"
...
void UGCN_EnvCampFire_StokeBurst_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_EnvCampFire_StokeBurst_C", "OnBurstGeneric");

	Params::GCN_EnvCampFire_StokeBurst_C_OnBurstGeneric Parms{};
