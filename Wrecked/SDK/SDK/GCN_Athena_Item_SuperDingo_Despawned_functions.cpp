...
#include "GCN_Athena_Item_SuperDingo_Despawned_classes.hpp"
#include "GCN_Athena_Item_SuperDingo_Despawned_parameters.hpp"
...
void UGCN_Athena_Item_SuperDingo_Despawned_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Athena_Item_SuperDingo_Despawned_C_OnBurst Parms{};
