...
#include "GCN_SpeedBoost_classes.hpp"
#include "GCN_SpeedBoost_parameters.hpp"


namespace SDK
{

// Function GCN_SpeedBoost.GCN_SpeedBoost_C.OnBurstGeneric
...
void UGCN_SpeedBoost_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_SpeedBoost_C", "OnBurstGeneric");

	Params::GCN_SpeedBoost_C_OnBurstGeneric Parms{};
