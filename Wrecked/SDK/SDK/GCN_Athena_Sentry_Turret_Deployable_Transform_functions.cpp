...
#include "GCN_Athena_Sentry_Turret_Deployable_Transform_classes.hpp"
#include "GCN_Athena_Sentry_Turret_Deployable_Transform_parameters.hpp"
...
void UGCN_Athena_Sentry_Turret_Deployable_Transform_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_Sentry_Turret_Deployable_Transform_C", "OnBurstGeneric");

	Params::GCN_Athena_Sentry_Turret_Deployable_Transform_C_OnBurstGeneric Parms{};
