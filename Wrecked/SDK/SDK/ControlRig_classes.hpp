...
{
public:
	TSoftObjectPtr<class UControlRigShapeLibrary> ShapeLibrary;                                      // 0x0100(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           ShapeNames;                                        // 0x0120(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	class UControlRigShapeLibrary*                ShapeLibraryCached;                                // 0x0130(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_590[0xA8];                                     // 0x0590(0x00A8)(Fixing Size After Last Property [ Dumper-8 ])
	struct FRigInfluenceMapPerEvent               Influences;                                        // 0x0638(0x0060)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_698[0xB8];                                     // 0x0698(0x00B8)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_7A0[0xD0];                                     // 0x07A0(0x00D0)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_871[0x17];                                     // 0x0871(0x0017)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_889[0x18F];                                    // 0x0889(0x018F)(Fixing Size After Last Property [ Dumper-8 ])
	struct FRigModuleSettings                     RigModuleSettings;                                 // 0x0A18(0x0078)(NativeAccessSpecifierPrivate)
	class FString                                 RigModuleNameSpace;                                // 0x0A90(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
// 0x0190 (0x0C30 - 0x0AA0)
class UModularRig final : public UControlRig
{
public:
	TArray<struct FRigModuleInstance>             Modules;                                           // 0x0AA0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_AB0[0x20];                                     // 0x0AB0(0x0020)(Fixing Size After Last Property [ Dumper-8 ])
	struct FModularRigSettings                    ModularRigSettings;                                // 0x0AD0(0x0001)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_AD1[0x7];                                      // 0x0AD1(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	struct FModularRigModel                       ModularRigModel;                                   // 0x0AD8(0x00A0)(NativeAccessSpecifierPublic)
	TArray<struct FRigModuleExecutionElement>     ExecutionQueue;                                    // 0x0B78(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B88[0xA8];                                     // 0x0B88(0x00A8)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_A3[0x131];                                     // 0x00A3(0x0131)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_1D8[0x70];                                     // 0x01D8(0x0070)(Fixing Size After Last Property [ Dumper-8 ])
	class URigHierarchyController*                HierarchyController;                               // 0x0248(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_250[0x8];                                      // 0x0250(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	class UModularRigRuleManager*                 RuleManager;                                       // 0x0258(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_260[0x50];                                     // 0x0260(0x0050)(Fixing Size After Last Property [ Dumper-8 ])
	TMap<struct FRigElementKey, struct FRigElementKey> PreviousNameMap;                              // 0x02B0(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_300[0xF8];                                     // 0x0300(0x00F8)(Fixing Size After Last Property [ Dumper-8 ])
	class URigHierarchy*                          HierarchyForCacheValidation;                       // 0x03F8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_400[0xC0];                                     // 0x0400(0x00C0)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	TSoftObjectPtr<class UControlRig>             ControlRig;                                        // 0x0060(0x0020)(BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ControlName;                                       // 0x0080(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TSubclassOf<class UControlRig>                ControlRigClass;                                   // 0x0508(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreInitializeDelegate;   // 0x0510(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostInitializeDelegate;  // 0x0520(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreConstructionDelegate; // 0x0530(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostConstructionDelegate; // 0x0540(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreForwardsSolveDelegate; // 0x0550(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostForwardsSolveDelegate; // 0x0560(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<struct FControlRigComponentMappedElement> UserDefinedElements;                            // 0x0570(0x0010)(Edit, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<struct FControlRigComponentMappedElement> MappedElements;                                 // 0x0580(0x0010)(Edit, ZeroConstructor, EditConst, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bEnableLazyEvaluation;                             // 0x0590(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_591[0x3];                                      // 0x0591(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	float                                         LazyEvaluationPositionThreshold;                   // 0x0594(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LazyEvaluationRotationThreshold;                   // 0x0598(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LazyEvaluationScaleThreshold;                      // 0x059C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bResetTransformBeforeTick;                         // 0x05A0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bResetInitialsBeforeConstruction;                  // 0x05A1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateRigOnTick;                                  // 0x05A2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateInEditor;                                   // 0x05A3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawBones;                                        // 0x05A4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowDebugDrawing;                                 // 0x05A5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5A6[0x2];                                      // 0x05A6(0x0002)(Fixing Size After Last Property [ Dumper-8 ])
	class UControlRig*                            ControlRig;                                        // 0x05A8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5B0[0xC0];                                     // 0x05B0(0x00C0)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_AA0[0x10];                                     // 0x0AA0(0x0010)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	TArray<bool>                                  IsControlActive;                                   // 0x0AA0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	EControlRigFKRigExecuteMode                   ApplyMode;                                         // 0x0AB0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_AB1[0x2F];                                     // 0x0AB1(0x002F)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_29[0x67];                                      // 0x0029(0x0067)(Fixing Struct Size After Last Property [ Dumper-8 ])
