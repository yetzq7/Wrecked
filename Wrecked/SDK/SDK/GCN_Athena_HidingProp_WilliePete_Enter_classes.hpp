...
class UGCN_Athena_HidingProp_WilliePete_Enter_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Athena_HidingProp_WilliePete_Enter_C">();
	}
	static class UGCN_Athena_HidingProp_WilliePete_Enter_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Athena_HidingProp_WilliePete_Enter_C>();
	}
};
