...
public:
	...
	struct FGameplayTag                           CallFunc_MakeLiteralGameplayTag_ReturnValue;       // 0x004C(0x0004)(NoDestructor, HasGetValueTypeHash)
	...
	class UFortWeaponItemDefinition*              CallFunc_GetWeaponData_ReturnValue;                // 0x0080(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_DoesItemDefinitionHaveGameplayTag_ReturnValue; // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function AnimNotifyState_HolsterWeaponIfNotConsumable.AnimNotifyState_HolsterWeaponIfNotConsumable_C.CanApplyHolster
// 0x0008 (0x0008 - 0x0000)
struct AnimNotifyState_HolsterWeaponIfNotConsumable_C_CanApplyHolster final
{
public:
