...
struct WBP_UIKit_Block_SideNav_Tab_Background_C_PreConstruct final
{
public:
...
struct WBP_UIKit_Block_SideNav_Tab_Background_C_ExecuteUbergraph_WBP_UIKit_Block_SideNav_Tab_Background final
{
public:
	...
	float                                         CallFunc_GetEndTime_ReturnValue_2;                 // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetEndTime_ReturnValue_3;                 // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationForward_ReturnValue_2;       // 0x0078(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
