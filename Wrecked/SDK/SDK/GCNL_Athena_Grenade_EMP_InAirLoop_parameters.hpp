...
struct GCNL_Athena_Grenade_EMP_InAirLoop_C_ExecuteUbergraph_GCNL_Athena_Grenade_EMP_InAirLoop final
{
public:
	...
	class APrj_Athena_Grenade_EMP_C*              K2Node_DynamicCast_AsPrj_Athena_Grenade_EMP;       // 0x0208(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UFXSystemComponent*                     CallFunc_SpawnFXSystemAttached_ReturnValue;        // 0x0218(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct GCNL_Athena_Grenade_EMP_InAirLoop_C_OnLoopingStartGeneric final
{
public:
...
struct GCNL_Athena_Grenade_EMP_InAirLoop_C_OnRemovalGeneric final
{
public:
	class AActor*                                 MyTarget;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                 Parameters;                                        // 0x0008(0x00D0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
