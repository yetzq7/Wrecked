...
#include "GCN_Athena_Item_JollyRascal_Main_Destroy_classes.hpp"
#include "GCN_Athena_Item_JollyRascal_Main_Destroy_parameters.hpp"
...
void UGCN_Athena_Item_JollyRascal_Main_Destroy_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Athena_Item_JollyRascal_Main_Destroy_C_OnBurst Parms{};
