...
{
public:
	TOptional<class FString>                      StrOptional;                                       // 0x0000(0x0018)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TOptional<class FString>                      StrOptionalUnset;                                  // 0x0018(0x0018)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TOptional<int32>                              IntOptional;                                       // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TOptional<int32>                              IntOptionalUnset;                                  // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TOptional<class FName, true>                  NameOptional;                                      // 0x0040(0x0004)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TOptional<class FName, true>                  NameOptionalUnset;                                 // 0x0044(0x0004)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	TOptional<struct FStructSerializerBuiltinTestStruct> StructOptional;                             // 0x0050(0x00E0)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TOptional<struct FStructSerializerBuiltinTestStruct> StructOptionalUnset;                        // 0x0130(0x00E0)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FStructSerializerOptionalTestStruct    Optionals;                                         // 0x0490(0x0210)(NativeAccessSpecifierPublic)
	struct FStructSerializerLWCTypesTest          LWCTypes;                                          // 0x06A0(0x0360)(NativeAccessSpecifierPublic)
};
