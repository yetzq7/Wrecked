...
#include "GCN_SupplyDropRadio_SupplyDrop_Spawn_classes.hpp"
#include "GCN_SupplyDropRadio_SupplyDrop_Spawn_parameters.hpp"
...
void AGCN_SupplyDropRadio_SupplyDrop_Spawn_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_SupplyDropRadio_SupplyDrop_Spawn_C", "OnBurstGeneric");

	Params::GCN_SupplyDropRadio_SupplyDrop_Spawn_C_OnBurstGeneric Parms{};
